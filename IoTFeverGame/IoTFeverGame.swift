...
class LevelBuilder {
    ...
    static func createLevelOne() -> Level {
        ...
        return Level(name: 1, duration: 10, delayBetweenMoves: 2.0, color: "25500",possibleDanceMoves : danceMoves)
    }
    ...
    static func createLevelTwo() -> Level {
        ...
        return Level(name: 2, duration: 15, delayBetweenMoves: 1.5, color: "12750",possibleDanceMoves : danceMoves)
    }
    ...
    static func createLevelThree() -> Level {
        ...
        return Level(name: 3, duration: 10, delayBetweenMoves: 1.0, color: "0",possibleDanceMoves : danceMoves)
    }
}
